(function() {
    ...
    TSlider.prototype = {
        ...
        _enterAnimation: function() {
            ...
            t.to(self.sld[self.current], 2.5, {
                scale: 1,
                opacity: 1
            });
            t.to(self.navigation, 1.2, {
                opacity: 1,
                y: 0
            }, 0.8);
            t.restart();
        ...
        /*
            ...
            2) Apareceu? Come莽ou contagem.
            3) Acabou contagem, transiciona.
            4) Acabou transi莽茫o? Aparece novo slide.
        */
        _startSlider: function() {
            ...
            // console.log('Come莽a contagem do slide ' + this.current + '.');
            ...
            function animateCurrNavItem(el) {
                ...
                TweenMax.to(el.querySelector('.li__info-mask'), self.sldInterval / 1000, {
                    ...
                    onComplete: function() {
                        // console.log('Agora, aciona as transi莽玫es.');
                        slidesTransitions();
                    }
                });
            }
            function slidesTransitions() {
                ...
                var tm = new TimelineMax({
                    onComplete: function() {
                        // console.log('Transi莽茫o de slides terminado.');
                ...
                tm.to(currBgSldImage, 1.2, {
                    scale: 1.35
                }, 0.15);
                tm.to(currSlide, 1.2, {
                    y: window.innerHeight
                }, 0.8);
                tm.to(currBgSlide, 1.2, {
                    height: '0%'
                }, 0.8);
                // Next elements animations
                tm.to(self.sld[nextIndex], 1.2, {
                    y: 0
                }, 0.8);
                tm.to(self.sld[nextIndex], 1.5, {
                    scale: 1
                }, 1.8);
                tm.to(self.bgSld[nextIndex].querySelector('.bi__imgCont-img'), 1.5, {
                    y: 0
                }, 1);
                tm.to(self.bgSld[nextIndex].querySelector('.bi__imgCont-img'), 1.5, {
                    scale: 1.5
